...
class Controller {
  async addItem(req, res) {
    ...
    try {
      ...
      sendResponse(res, 200, true, "Product created successfully", product);
    } catch (error) {
      console.log(error);
      errorResponse(res);
    }
  ...
  async buyItem(req, res) {
    try {
      ...
      if (product.quantity < Number(quantity)) {
        return errorResponse(res, `Product remaining ${product.quantity}!`);
      }
  ...
  async getActiveItem(req, res) {
    try {
      ...
      return successResponse(res, "Fetched Active Item Successfully!", item);
    } catch (error) {
      console.log(error);
      errorResponse(res);
    }
  ...
  async setActiveItem(req, res) {
    try {
      ...
      sendResponse(res, 200, true, "Updated active item successfully", item);
    } catch (error) {
      console.log(error);
      errorResponse(res);
    }
